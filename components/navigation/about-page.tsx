    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <section className="mb-12 bg-white rounded-lg shadow-lg p-8 border border-gray-200">
        ...
        <p className="text-gray-700">
          With over 900 policy documents published across 9 departments, staying current with AI regulations 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg p-4 border border-primary-200">
            ...
            <p className="text-sm text-gray-600">
              650+ AI-specific policies from 9 government departments, automatically updated weekly
            </p>
          </div>
      ...
      <section className="mb-12 bg-white rounded-lg shadow-lg p-8 border border-gray-200">
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-1">Intelligent Categorization</h3>
              <p className="text-gray-600 text-sm">
                Each policy is automatically categorized by type (regulation, strategic guidance, research), 
      ...
      <section className="mb-12 bg-white rounded-lg shadow-lg p-8 border border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm">
              Analyze UK AI policy landscape, identify gaps, and provide evidence-based recommendations 
              to clients.
            </p>
          </div>
        </div>
      ...
      <section className="mb-12 bg-white rounded-lg shadow-lg p-8 border border-gray-200">
        ...
        <div className="space-y-4 text-gray-700">
          ...
          <div>
            <h3 className="font-semibold text-gray-900 mb-1">Categorization</h3>
            <p className="text-sm">
              Policies are categorized by type (regulation vs guidance vs research), sector focus, 
      ...
      <section className="mb-12 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg shadow-lg p-8 border border-gray-200">
        ...
        <div className="mb-6">
          <h3 className="text-xl font-semibold text-gray-900 mb-2">PK Boakye</h3>
          <p className="text-gray-600 mb-4">
            Digital Collections Specialist | AI Implementation Expert
          </p>
          
          <p className="text-gray-700 mb-4">
            PK is a Digital Collections Specialist at Oakbrook Finance with expertise in building enterprise 
            AI solutions. His work includes developing a Microsoft Copilot Studio knowledge agent serving 80+ 
            users, which reduced complaint handling time by 45%.
          </p>
          
          <p className="text-gray-700 mb-4">
            With a BSc in Politics from the London School of Economics and previous experience in private 
            equity and consulting, PK specializes in transforming complex policy and data challenges into 
            practical business intelligence tools.
          </p>
          
          <p className="text-gray-700">
            This project demonstrates full-stack development capabilities, AI integration, and the ability 
            to deliver production-ready solutions that address real business problems in the AI governance space.
          </p>
        </div>

        {/* Skills Demonstrated */}
        <div className="bg-white rounded-lg p-6 mb-6 border border-gray-200">
          <h3 className="font-semibold text-gray-900 mb-3">Skills Demonstrated</h3>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            <div className="text-sm text-gray-700">✓ Full-Stack Development</div>
            <div className="text-sm text-gray-700">✓ API Integration</div>
            <div className="text-sm text-gray-700">✓ Data Processing & Analysis</div>
            <div className="text-sm text-gray-700">✓ AI Implementation</div>
            <div className="text-sm text-gray-700">✓ TypeScript/React/Next.js</div>
            <div className="text-sm text-gray-700">✓ Data Visualization</div>
            <div className="text-sm text-gray-700">✓ System Architecture</div>
            <div className="text-sm text-gray-700">✓ Production Deployment</div>
            <div className="text-sm text-gray-700">✓ UX/UI Design</div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <a
            href="https://github.com/Boakye-20/uk-ai-policy-tracker"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <p className="text-sm text-gray-600 mt-6 italic">
          Open to opportunities in AI consulting, revenue operations, and investment management.
        </p>
      </section>
